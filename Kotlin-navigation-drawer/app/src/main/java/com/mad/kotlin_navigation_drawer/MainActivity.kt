...
//        }
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_gallery -> {
                Toast.makeText(applicationContext, "gallery", Toast.LENGTH_LONG).show()

            }
            R.id.nav_slideshow -> {
                Toast.makeText(applicationContext, "slideshow", Toast.LENGTH_LONG).show()

            }
            R.id.nav_manage -> {
                Toast.makeText(applicationContext, "manage", Toast.LENGTH_LONG).show()
